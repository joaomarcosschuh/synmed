  ...
  Widget build(BuildContext context) {
    double totalWidth =
        (widget.categories.length + 1) *
            (2 * CategoryHeader.circleAvatarPadding +
                2 * CategoryHeader.circleAvatarRadius);
    ...
    return Container(
      height:
      60 + 2 * CategoryHeader.circleAvatarPadding + 2 * CategoryHeader.circleAvatarRadius,
      child: Stack(
        children: [
          Positioned(
            top: 8,
          ...
          Positioned(
            ...
            child: Container(
              height:
              2 * CategoryHeader.circleAvatarRadius + 2 * CategoryHeader.circleAvatarPadding,
                  ...
                  return Padding(
                    ...
                    child: InkWell(
                      onTap: () {
                        ...
                        Provider.of<SelectedDecks>(context, listen: false);
                        if (isSelected) {
                          selectedDecks.removeDeckFromCategory(
                              selectedDecks.selectedCategory, category); // Corrigir selectedDecks.selectedCategory para widget.user.selectedCategory
                          setState(() {
                            selectedCategories.remove(category);
                          });
                        } else {
                          selectedDecks.addDeckToCategory(
                              selectedDecks.selectedCategory, category); // Corrigir selectedDecks.selectedCategory para widget.user.selectedCategory
                          setState(() {
